...
def get_vocab(train_src, train_tgt, vocab_file):

    print('read in source sentences: %s' % train_src)
    print('read in target sentences: %s' % train_tgt)

    src_sents = get_vocab_list(train_src, source='src', vocab_size=21000)         
    tgt_sents = get_vocab_list(train_tgt, source='tgt', vocab_size=8000)
